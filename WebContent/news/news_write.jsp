            ...
            <form action="/Cit/NewsWriteController.do" method="post" id="frm" name="newsWriteForm">
                <table class="news-write-table">
                    <tr>
                        ...
                        <td colspan="2"><div class="editor-title"><input class="editer-title-input" type="text" name="title"></div></td>
                    </tr>
                    <tr>
                        <td><div class="editor-writer-1">작성자</div></td>
                        <td><div class="editor-writer"><input class="editor-writer-input" type="text" name="author"></div></td>
                        <td><div class="editor-writer-1">원문링크</div></td>
                        <td><div class="editor-writer"><input class="editor-writer-input originallink" type="url" name="newsLink"></div></td>
                    </tr>
                </table>
